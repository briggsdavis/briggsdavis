...
export interface Project {
  ...
  postFeatureImages?: [string, string]
  description: string
...
const projectCatalog: Project[] = [
  {
    ...
    image: "/images/projects/social-satisfaction/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/social-satisfaction/detail-1.jpg",
      "/images/projects/social-satisfaction/detail-2.jpg",
      "/images/projects/social-satisfaction/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/social-satisfaction/result-1.jpg",
      "/images/projects/social-satisfaction/result-2.jpg",
    ],
    shortDescription:
  ...
  },
  {
    id: "oderum",
    name: "Oderum",
    image: "/images/projects/oderum/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/oderum/detail-1.jpg",
      "/images/projects/oderum/detail-2.jpg",
      "/images/projects/oderum/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/oderum/result-1.jpg",
      "/images/projects/oderum/result-2.jpg",
    ],
    description:
  ...
  },
  {
    ...
    image: "/images/projects/hormone-vitality-coaching/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/hormone-vitality-coaching/detail-1.jpg",
      "/images/projects/hormone-vitality-coaching/detail-2.jpg",
      "/images/projects/hormone-vitality-coaching/detail-3.jpg",
    ],
    shortDescription:
  ...
  },
  {
    ...
    image: "/images/projects/ease-engineering/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/ease-engineering/detail-1.jpg",
      "/images/projects/ease-engineering/detail-2.jpg",
      "/images/projects/ease-engineering/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/ease-engineering/result-1.jpg",
      "/images/projects/ease-engineering/result-2.jpg",
    ],
    description:
  ...
  },
  {
    id: "nordic-seafood",
    name: "Nordic Seafood",
    image: "/images/projects/nordic-seafood/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/nordic-seafood/detail-1.jpg",
      "/images/projects/nordic-seafood/detail-2.jpg",
      "/images/projects/nordic-seafood/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/nordic-seafood/result-1.jpg",
      "/images/projects/nordic-seafood/result-2.jpg",
    ],
    shortDescription:
  ...
  },
  {
    ...
    image: "/images/projects/africa-growth-axis/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/africa-growth-axis/detail-1.jpg",
      "/images/projects/africa-growth-axis/detail-2.jpg",
      "/images/projects/africa-growth-axis/detail-3.jpg",
    ],
    shortDescription:
  ...
  },
  {
    ...
    image: "/images/projects/brac-stone-house/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/brac-stone-house/detail-1.jpg",
      "/images/projects/brac-stone-house/detail-2.jpg",
      "/images/projects/brac-stone-house/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/brac-stone-house/result-1.jpg",
      "/images/projects/brac-stone-house/result-2.jpg",
    ],
    description:
  ...
  },
  {
    ...
    image: "/images/projects/butcher-and-the-rye/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/butcher-and-the-rye/detail-1.jpg",
      "/images/projects/butcher-and-the-rye/detail-2.jpg",
      "/images/projects/butcher-and-the-rye/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/butcher-and-the-rye/result-1.jpg",
      "/images/projects/butcher-and-the-rye/result-2.jpg",
    ],
    shortDescription:
  ...
  },
  {
    id: "hargarten",
    name: "Hargarten",
    image: "/images/projects/hargarten/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/hargarten/detail-1.jpg",
      "/images/projects/hargarten/detail-2.jpg",
      "/images/projects/hargarten/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/hargarten/result-1.jpg",
      "/images/projects/hargarten/result-2.jpg",
    ],
    shortDescription:
  ...
  },
  {
    id: "refenti",
    name: "Refenti",
    image: "/images/projects/refenti/cover.jpg",
    overview:
    ...
    caseStudyImages: [
      "/images/projects/refenti/detail-1.jpg",
      "/images/projects/refenti/detail-2.jpg",
      "/images/projects/refenti/detail-3.jpg",
    ],
    postFeatureImages: [
      "/images/projects/refenti/result-1.jpg",
      "/images/projects/refenti/result-2.jpg",
    ],
    shortDescription:
...
const duplicateIds = projectCatalog
  .map((project) => project.id)
  .filter((id, index, ids) => ids.indexOf(id) !== index)
const missingOrderedProjects = portfolioOrder.filter((id) => !projectsById.has(id))

if (duplicateIds.length || missingOrderedProjects.length) {
  throw new Error(
    `Invalid project catalogue: ${[
      duplicateIds.length ? `duplicate IDs (${duplicateIds.join(", ")})` : "",
      missingOrderedProjects.length
        ? `missing ordered IDs (${missingOrderedProjects.join(", ")})`
        : "",
    ]
      .filter(Boolean)
      .join("; ")}`,
...
export const projects = portfolioOrder.map((id) => projectsById.get(id)!)

export const getProject = (id: string | undefined) => projectsById.get(id ?? "")
