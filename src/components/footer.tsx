...
const Footer = () => {
  ...
  return (
    <footer
      id="contact"
      ref={sectionRef}
      className="border-t border-border/30 bg-background px-6 py-20"
    >
      <div className="mx-auto max-w-6xl">
        ...
        {/* Footer Bottom */}
        <div
          className={`flex flex-col items-center justify-between gap-4 border-t border-border/30 pt-8 opacity-0 [animation-delay:400ms] lg:flex-row ${
            isVisible ? "animate-fade-in-up" : ""
          }`}
        >
          <div className="flex items-center gap-2">
            <img src="/brand/logo.png" alt="Briggs Davis Logo" className="h-8 w-8 object-contain" />
