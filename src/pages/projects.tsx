  ...
  return (
    <div>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center">
        <span className="mb-8 animate-fade-in-up font-eyebrow text-xs font-medium tracking-widest text-muted-foreground uppercase opacity-0 [animation-delay:100ms]">
          Case Studies
        </span>

        <h1 className="animate-fade-in-up opacity-0 [animation-delay:200ms]">
          <span className="block text-6xl font-semibold tracking-tight text-foreground md:text-8xl lg:text-9xl">
            Portfolio
          </span>
        ...
        <p className="mx-auto mt-10 max-w-lg animate-fade-in-up text-lg text-muted-foreground opacity-0 [animation-delay:300ms]">
        ...
        <div className="mt-12 flex animate-fade-in-up flex-col items-center gap-6 opacity-0 [animation-delay:400ms]">
          <div className="flex flex-wrap justify-center gap-3">
            {["Web Design", "E-Commerce", "Branding", "CMS", "Real Estate", "Advisory"].map(
              (tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-border/40 px-4 py-1.5 text-xs font-medium tracking-widest text-muted-foreground/60 uppercase"
                >
                  {tag}
                </span>
              ),
          ...
          {projects.map((project, i) => (
            <div
              ...
              className={`transition-all duration-700 ease-out ${
                visibleSet.has(i) ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
              }`}
            >
                ...
                <div className="flex flex-col gap-5">
                  <div className="flex flex-wrap gap-2">
                    {project.tags.slice(0, 2).map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full border border-border/60 px-4 py-1.5 text-xs font-medium tracking-widest text-muted-foreground uppercase"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <Link
                    ...
                    className="group inline-flex h-11 w-fit items-center justify-center gap-2 rounded-full border border-border/30 bg-card/60 px-8 text-xs font-medium tracking-wide text-foreground uppercase backdrop-blur-[20px] transition-colors hover:bg-secondary/50 focus-visible:outline-2 focus-visible:outline-offset-2"
                  >
