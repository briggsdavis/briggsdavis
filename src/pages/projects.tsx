  ...
  return (
    <div>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center">
        <span className="mb-8 animate-fade-in-up font-eyebrow text-xs font-medium tracking-[0.3em] text-muted-foreground uppercase opacity-0 [animation-delay:100ms]">
          Case Studies
        </span>
