  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        {/* Hero image */}
        <div className="rounded-2xl overflow-hidden mb-12 border border-border/30">
          <img
            src={project.image}
            alt={project.name}
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          {/* Features */}
          <div>
            <h3 className="text-xs font-medium tracking-[0.3em] text-muted-foreground uppercase mb-6">
              Key Features
            </h3>
